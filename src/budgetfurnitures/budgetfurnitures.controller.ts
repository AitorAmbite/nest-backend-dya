...
export class BudgetfurnituresController {
  constructor(private readonly budgetfurnituresService: BudgetfurnituresService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateBudgetfurnitureDto: UpdateBudgetfurnitureDto) {
